...
def fedadam_strategy(initial_parameters, client_config, strategy_name, adpater_name="default", seed=42):
    """
    Implement FedAvg Strategy
    """
    class FedAdamModelStrategy(fl.server.strategy.FedAdam):
        def aggregate_fit(
            self,
            server_round: int,
